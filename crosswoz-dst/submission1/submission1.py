...
class GPT2DSTEnglish(DST):
    model_checkpoint = "ytlin/1amet0ls"
    num_history_turns = -1
    lang = "en"
    MAX_LENGTH = 512
    MIN_BELIEF_LEN = 128
    MAX_FOR_PROMPT = MAX_LENGTH - MIN_BELIEF_LEN
    carry_slot_values = True
    ...
    def __init__(self):
        ...
        self.model = (
            GPT2LMHeadModel.from_pretrained(self.model_checkpoint)
            .eval()
            .to(self.device)
        )
    ...
    def update_turn(self, sys_utt, user_utt):
        ...
        input_ids = build_lm_sequence(
            self.tokenizer, system_utterances, user_utterances, self.lang, add_eos=False
        )["input_ids"]

        if len(input_ids) > self.MAX_FOR_PROMPT:
            input_ids = self.truncate_front(input_ids)
        ...
        gen = self.tokenizer.decode(gen_tokens)
    ...
    def truncate_front(self, seq: List) -> List:
        return seq[len(seq) - self.MAX_FOR_PROMPT :]

    def parse_belief(self, gen: str) -> Dict[str, Dict[str, str]]:
        belief_str = (
            gen.split(BELIEF, 1)[-1]
            .strip()
            .rsplit(self.tokenizer.eos_token, 1)[0]
            .strip()
        )
        ...
        for slot in slots:
            domain = slot[0].strip()
            slot_name = slot[1].strip() if len(slot) >= 2 else ""
            slot_value = slot[2].strip() if len(slot) >= 3 else ""
...
ontology = {
    "Attraction": {
        "name": [
            ...
            "Tuan Cheng Fortress",
            "Eighteen Ponds in the West of Beijing",
            ...
            "Jirecha Tingjin Army Exhibition Hall of  Former Military Headquarters",
    ...
    "Restaurant": {
        "name": [
            ...
            "Yangfang Shengli Mutton Hotpot (Jinyuanzhuang)",
            "Donglaishun Restaurant (Temple of Heaven)",
            "Honglu HotSpring Villa Eco Gourmet Restaurant",
            "Haidilao Hot Pot",
            ...
            "Yulin Roast Duck Restaurant (Majuqiao)",
            "Wangpo Prawn",
            ...
            "Atian Prawn (Yanqing Headquarter)",
            "Shengcundao Restaurant",
            ...
            "Zantunzi Guotaiyu",
            "Qianhuifeng Yuzhou Griddle Duck Head",
            ...
            "Wushan Grilled Fsh",
            "Hulunbeier Mongolia Gourmet",
            "Dining Hall of Lvzhou Shuixiang Hotspring Resort ",
            ...
            "Xinlong Four Season Hotpot (Liangxiang )",
            "Curry Beef Rice",
            ...
            " Deshunlou Dumpling House",
            "Guanyejie Macow Hot Pot (China World Mall）",
            "Miyun Reservoir Fuhai Restaurant",
            "Fragrant Court",
            ...
            "Peking University Yannan Gourmet",
            "Jingxinju Farmhouse",
            "Fish Chef Farmhouse Food Plaza ",
            ...
            "Jingbin Hotel Restaurant",
            "Hua Bin International Hotel Fulinge Restaurant",
            "Dongxing Shun Burst Belly Zhang",
            ...
            "Beijing Zengyuan Kitchen Hot Pot City (Yanqing Hengsheng)",
            "Niujie Hongji Snack Restaurant (Niujie New Store)",
            "Siji Minfu Roast Duck Restaurant (Dengshikou)",
            "Fuhua Mountain Villa",
            "Jingwuzhen Roasted Whole Lamb (Longcheng Headquater)",
            "Yudouji (Dahui Temple)",
            "Nailao Wei (Niujie Headquarter)",
            "Holiland(Longhua)",
            ...
            "Caffe Bene (BHG Lippo Shopping Mall)",
            ...
            "Tongheju Restaurant",
            "Lai Yifen (Yulong Garden Fourth District)",
            ...
            "Huguosi Snack",
            "Shijia Courtyard",
            "Xinderun Roast Duck Restaurant",
            ...
            "Wangshunge Fish Head Soak Cake (Mentougou)",
            "Cherry Orchard",
            "Songzi Japanese Cuisine（Liangmaqiao）",
            "Dayali Roast Duck (Mentougou)",
            "Yunhu Resort Restaurant",
            "Dingjiaxuan Lamb Spine Hot Pot",
            "Honghong Huohuo Baxiang Stone Pot Fish",
            "Lao Keng Ji (Kade Mall Sun Palace)",
            "Miao Ying Bamboo Goose",
            "Jindingxuan· North and South Dishes (Temple of Earth）",
            "Fuhaiju·Bread Soaked in Fish Head Soup (Fengtai)",
            "Hehegu (Liangxiang Huaguan)",
            "JUMBO Seafood (Beijing skp)",
            ...
            "Beijing Jinhai Longquan Hongzunyu Barbecue City",
            "Han Jing Tai",
            "Tuye (Yanshajin Street)",
            "Duyue Villa",
            "Zhenglongzhai Vegetarian Restaurant",
            ...
            "Yuxin Sichuan Cuisine (Jingtai)",
            "Qing-Feng Steamed Dumpling Shop Badaling Great Wall Store (Guntiangou Parking)",
            "Baixin Northeast Farmhouse Bone Village",
            ...
            "Shisanling Shanshuiyayuan Farmhouse",
            "Feifeiju Village Cuisine ",
            ...
            "Shuangyuanhui Restaurant",
            "Laojiefang Kaikou Louxian Dumplings",
            "Big Pizza (Xiwai)",
            "Yatai Flavor Restaurant",
            "Qiuweidao Home Dishes",
            "Water Bay Tribe",
            "Mr. Fruit",
            ...
            "Mcdonalds (Luyuan South Street 6dt)",
            "Heqingzhai (Nanshao Direct-sale)",
            "Yangdaye Hot Pot (Xiyuan)",
            "Colorful Life Photography Food House",
            "Tairyo(Blue Harbor)",
            "Nuage (Shichahai)",
            "Youth Restaurant (Liuliqiao)",
            "Jinfuyuan Shanxi noodles",
            "Wetlands Club Western Restaurant",
            "Black Swan Luxury Cake (Chaoyangmen)",
            ...
            "Belencre",
            "Niantan Park",
            "Guanlong Shanzhuang Fishing Village",
            ...
            "Jinshoushao Restaurant (Huairou)",
            "Ice City Barbecue",
            "Bursting Belly Jin Shenglong",
            ...
            "Peking Garden Boutique Hotel (Zhongliang Xiangyun)",
            "Sanjiangyuan Restaurant ",
            ...
            "Villa Castanea",
            "Flavor Roast Lamb Leg",
            "Sunnyum (Gulou West Street）",
            "No. 7 Courtyard Restaurant  (Beiqijia)",
            "Yatai Hotel",
            ...
            "Haiyue Restaurant",
            "Gongyuan Shulou · Sichuan Office in Beijing",
            "Wang Peng Specialty Snack Restaurant ",
            "Grand Mercure Xidan",
            "Donglaishun Restaurant (Beijing apm)",
            "Chengbin Restaurant",
            ...
            "Jingge Chongqing Hot Pot (Ghost Street)",
            ...
            "Wanrong Roast Duck Restaurant (Dongguan)",
            "Hannashan",
            "Beijing Quanjude ",
            "Yuxiangyuan Hot Pot (Tongzhou Headquater)",
            ...
            "Moslem Changshun Beef Restaurant",
            ...
            "Grassland Star Lamb Hot Pot (Yanqing)",
            ...
            "Yun Ding Xuan",
            "Spicy Beauty Hoof",
            "Wanda Realm Beijing Gourmet Restaurant",
            "Kaorouwan Restaurant",
            "Muzhen (Shahe Store)",
            "CYTS Fashion Restaurant (Yanxi)",
            "Pizza No.5",
            "PALMS L.A. KITCHEN AND BAR (Liangma Qiao)",
            "Wanrong Roast Duck Restaurant",
            "KFC (Yungang)",
            "Beijing Daoxiangcun (Dengshikou Branch 2)",
            ...
            "No.5 Club KTV Cafeteria",
            "Jingdong Meat Pie Shop",
        ...
        "dishes": [
            ...
            "Roast fish with special flavor",
            "Shatian chicken soup",
            ...
            "Chicken chop with rattan pepper",
            "Pasta",
            ...
            "Refined fat beef slices",
            "Braised pork strips",
            "Rum chocolate and hazelnut meringue cake",
            "Roast duck buffet",
            "Sichuan-flavor glutinous rice cake",
            "Diced beef",
            "Ginseng and black bone chicken soup",
            "Crispy chicken popcorn",
            "pumpkin juice",
            "Qing yongzheng dynasty style",
            "Matsutake soup",
            "Xianghe meat pie",
            "Shrimp wonton soup",
            "baby lobster",
            ...
            "Yiyuan nutritious chicken soup",
            "Spicy Hot Pot",
            "Forbidden City",
            "Braised pork haslet",
            "Shining mashed potato",
            "Lamb shaomai (steamed dumpling)",
            "Braised curry and seafood en casserole",
            "Domestic chicken",
            "Spicy chicken wings",
            "Braiseed sea cucumber and goose feet in abalone sauce",
            "Tuna salad",
            "Roast rainbow trout",
            "Wheat gluten",
            ...
            "Meat pie",
            "Double chicken leg burger with rattan pepper taste",
            ...
            "Laopai aorta",
            "Fragrance of crispy durian pastry",
            "Refined lamb spine",
            ...
            "Lamb chop",
            "Sizzling fresh squid",
            "Three delicacies of lamb",
            ...
            "fired durian with wild berries",
            ...
            "Dongxiang sautéed potato slices",
            "Gristle",
            "Stewed assorted delicacies",
            "Tofu pot",
            "Gold braised pork",
            "Sautéed bos taurus beef",
            ...
            "Baked butter bread stuffed with jujube paste",
            "Fries with mustard and honey",
            "beans",
            "Sause",
            "Sesame paste",
            "Haidilao condiment sauce",
            "Bullfrog",
            ...
            "Unique-flavor braised bone",
            "Homemade German brown ale",
            "Roast fish",
            ...
            "Star chef",
            "Gold fat beef slices combination",
            ...
            "Walnut shortbread",
            "Shaomai (steamed pork dumpling) stuffed with leek and eggs",
            "Spicy bullfrog",
            ...
            "Storm",
            "Grilled chicken wings in mustard sauce",
            ...
            "Two hours",
            "Stewed fish belly with saffron sauce",
            ...
            "White fungus soup with rock sugar",
            ...
            "Assorted noodle",
            "Scrambled eggs",
            "Steamed bun in triangular shape stuffed with sugar",
            "Stir-fried eels with bamboo shoots",
            "Duck skin slices",
            "One hour",
            ...
            "Beef seasoned cooked with five spices",
            "Seafood",
            "Chocolate lava cake",
            ...
            "Rice of curry chicken and yu-shiang shredded pork",
            "Sliced boiled pork casserole",
            "Pineapple pastry",
            ...
            "cucumber mixed with pig's-head meat",
            ...
            "Beijng cheese",
            "Mongolia milk tea",
            "Braised pork intestines with sour garlic",
            "Small buffet",
            "Meat bun",
            ...
            "Napoleon",
            "Sliced crab meat",
            "Lamb spine with a secret cuisine",
            "Paste platter",
            ...
            "Rice served with leek and eggs on top",
            "Crusty pancake stuffed with hawthorn fillings",
            "House-made stewed chicken with three cups sauce",
            "Pan-fried “Rougié” goose liver",
            "Egg tart",
            "Spareribs",
            "Qingjiang fish",
            "Beef noodles",
            ...
            "Sautéed short rib in a stone pot with black pepper",
            "Fat beef slices on sale",
            "Luncheon meat",
            "Roast spicy fish",
            "Home cooking",
            ...
            "Yangzhou fried rice",
            "Stewed loofah and wheat gluten en Casserole",
            ...
            "Charcoal-grilled pancake stuffed with meat",
            "Stir-fried lamb with cumin",
            "Laopai spicy beef",
            "Pear soup and stir-fried bean sprout",
            "Dried fruit soup",
            "Yizhichan",
            ...
            "Pleurotus eryngii",
            "Baylor barbecue",
            "Chestnut saffron soup",
            "Honeycomb briquet",
            "Pear ball and crispy shrimps",
            "Flavored sea mustard",
            "rinse",
            "Fresh black mushroom",
            "Dim sum",
            "Garlic-flavor sausage",
            "Slightly",
            "Roast fat beef slices",
            "Braised pork slices",
            "Bibimbap",
            ...
            "Home-style tofu",
            "Frozen bean curd",
            "Qianyedoufu and beef",
            "Crab tofu",
            "Sautéed sweet corn with pine nuts",
            "Duck soup",
            "Classic roast duck",
            "Tendon",
            "Sautéed tofu with paste",
            "Seafood pie",
            "Swedish meatball",
            "Duck intestines",
            "Cilantro",
            ...
            "Ox tail soup",
            "Beef and lamb",
            "Sliced bread of meat floss and sea sedge",
            "Barbecue",
            "Corn tray",
            ...
            "Small domestic chicken",
            "Stir-fried bean sprouts",
            "intestinal",
            "Baked sweet wheaten cake",
            "Roast chicken wings in honey sauce",
            "Baked wheat cake stuffed with donkey meat",
            "Yiyuan-style spicy chicken",
            ...
            "Cold dishes",
            "Cuttlefish roe soup",
            "Signature fried rice with roast duck",
            ...
            "French bean and twisted rolls",
            "Lamb slices",
            "Fried river shrimp in hot and spicy sauce",
            "Fresh ox tripe",
            "Niumowang",
            "Oyster",
            "Wild jujube juice",
            "Bamboo shoots in chicken sauce",
            "Wonton noodle",
            "Bun",
            "Stir-fried pork meat",
            "Meringue Shrimp Restaurant",
            "Tiramisu",
            "Braised intestines in brown sauce",
            "Buttermilk",
            "Stewed chicken with three cups sauce in a pot",
            "Stewed donkey meat",
            ...
            "Signature fresh Inner Mongolia kidlet hind leg meat slices",
            "Prime lamb",
            ...
            "Flavored soy sauce duck",
            "Streaky pork of northeast China",
            "Bacon pizza",
            "House-made Mao Xue Wang",
            "Boiled vegetables",
            "Home-style pancake",
            ...
            "Fried pork",
            "Small cake",
            "Boiled chitterlings in baked wheaten paste",
            "Corn pancake",
            "Swallow tail and peach blossom-shaped shrimp",
            "50-100 yuan",
            "Crispy green peas cake",
            "Stewed fish",
            "Crucian and tofu soup",
            "Inner Mongolia kidlet slices",
            "German sausage",
            ...
            "Sautéed diced eggplant",
            "Rose pancake",
            "Signature noodles",
            "Sea cucumber",
            "fried prawns",
            "Deep-fried tofu skin",
            "twice-cooked Meizhou sausage",
            "Steamed bun stuffed with pork",
            "Peanuts",
            "Kingtrout",
            "stewed Chinese cabbage with powder block",
            "Salmon",
            "Seafood combination",
            "instant-boiled tripe",
            "Shortening jujube cake",
            "Cakes and pastry",
            "Taro ball",
            "Cold noodles",
            "Super French fries with meat sauce",
            "Baifu-style kung pao shrimp",
            "Steak",
            ...
            "Spinach and wheat gluten",
            "Hot chocolate drink",
            "Shortening cake",
            "Catfish filets in hot chili oil",
            "Spicy crab",
            "Braised vermicelli en casserole",
            "Sautéed French bean",
            ...
            "Japanese soybean paste stew",
            "Coffee latte",
            "Braised fish head in soy bean sauce",
            "Sautéed shredded squid in chili sauce",
            "Spicy chickens",
            "Others",
            "Pancake",
            ...
            "McCrispy chicken burger - deep-fried chicken drumsticks",
            ...
            "Sparkling wine",
            "vedgetable roll with egg wrapper",
            "ice cream",
            ...
            "Sour soup sole fish",
            "Stir fried hawthorn",
            "Chicken cooked with firewood",
            "Chuck roll",
            "Prime lamb chop roll",
            "Strawberry cheese",
            "Marinated egg",
            ...
            "Barbecues",
            "Sauce dish",
            "Waimai twist stuffed with meat (meat rolls)",
            ...
            "Mung bean porridge",
            "Sautéed fat beef slices with black pepper in stone pot",
            "Fried beef steak",
            "Shredded cabbage",
            "Dessert",
            "corn stubble porridge",
            "Bovine bone marrow",
            ...
            "Wangpo shrimp",
            "Tomato soup base",
            "Stir-fried leek with scallop",
            "Snails",
            "liver and kidney",
            "Meat broth",
            "Fried sugar cake",
            "Poached perch",
            "Steamed rice with black tea flavor",
            "Shark fin",
            "Quadrangle",
            ...
            "Salted duck eggs",
            "Instant-boiled tripe",
            "Baked B.B.Q. pork bun，Hong Kong style",
            "Time-honored brand",
            "Dongpo pork",
            "Panini burger",
            "Curry chicken",
            ...
            "Braised meat with hawthorn wine",
            "Hot pot",
            "Stewed black fish",
            "Spicy Chinese cabbage",
            "Braised Shatian pigeon",
            ...
            "Braised shark fin",
            "Roast special beef",
            "Sautéed diced chicken with double flavor mushroom",
            "Sirloin",
            "Homemade tofu",
            "Pickled cucumbers",
            "Matcha smoothie",
            "Dried French bean",
            "Braised noodles with French bean",
            "Roast lamb back",
            "Spicy duck liver",
            "Stewed and seasoned duck slices",
            ...
            "Scenic area",
            "Small cage beef",
            "Steamed duck intestines with diced hot red peppers",
            ...
            "Pork ball",
            "Small beef pancake and pork head meat",
            "Special lamb kebabs",
            ...
            "Sliced noodles",
            "Theme meal",
            "Braised meat and noodles",
            "Deep-fried bean curd",
            "Sashimi",
            "Double-flavor rainbow trout",
            "Shredded tripe and dried cowpea",
            "Special braised lamb",
            "Steamed sturgeon",
            "Big rooster chicken",
            "Spicy ox tongue",
            "Donkey board intestinal",
            "Braised Japanese tofu in brown sauce",
            "Tofu",
            "Braised pork ball",
            "Quick-fried tripe (mainly intestines)",
            "Sichuan style",
            "Spaghetti",
            "Bullfrog with dry pot",
            ...
            "Cappuccino",
            "Small croissant with maple sugar",
            "Donkey meat soup",
            "Sliced kelp in sauce",
            "Lentil spareribs rolls",
            ...
            "Black fungus with scallion and chili oil",
            "Stir-fried starch knots with meat",
            "Miso soup",
            "ribs",
            "Omelett",
            "sign",
            "Haidilao-style fried pork",
            "Sautéed duck hearts with Maotai liquor flavor",
            "Tiananmen Square",
            "Shredded pork",
            "Beer",
            "Antique barbecued BBQ pork pastry",
            "Sesame cake",
            "Daoxiangcun cakes",
            "Cocktail",
            "Pumpkin soup",
            ...
            "Lettuce",
            "Pig hock",
            "Orleans-flavor roasted chicken wings",
            "Double-flavor sausages",
            "Delicatessen",
            ...
            "Turnip peel salad",
            "pickled cabbage & baked corn pancake",
            ...
            "crispy rice with spicy chicken",
            "Fried liver",
            "Potato chips",
            "Spicy duck head",
            "Ancient style fish with bamboo shoots and shell in oil",
            ...
            "Turtle",
            "Deep-fried shrimps",
            "Xinjiang-style braised lamb chop with Nang (Xinjiang-style pancake)",
            "Northeast China hodgepodge",
            "Tomato and crispy mushroom salad",
    ...
    "Hotel": {
        "name": [
            ...
            "Shunjing SPA Hotel Beijing ",
            "7 Days Inn (Beijing Olympic Park Baoshengli)",
            "FX Hotel (Beijing Yansha)",
            "Nirvana Resort Beijing",
            "Liuhexiang Courtyard",
            "Kuntai Hotel",
            "Hi Inn (Beijing Daguanyuan)",
            "Kerry Hotel Beijing",
            "Hanting Hotel (Beijing New National Exhibition Center)",
            ...
            "7 Days Inn (Bird's Nest Stadium)",
            ...
            "Sunworld Dynasty Hotel Beijing Wangfujing",
            "Orange Hotel Select (Beijing Sanyuanqiao)",
            "Park Hyatt Beijing",
            "Home Inn Hotel (Beijing Guogongzhuang Subway Station)",
            "Jinjiang Inn (Beijing Guang'anmen)",
            "7 Days Inn (Beijing South Station Jiaomenxi Subway Station)",
            "7 Days Inn (Beijing Shangdi Xisanqiaoxi)",
            ", Hi Inn (Beijing Muxiyuan)",
            "Ganlanshu Siji Spa Hotel (Beijing Liangxiang University City)",
            "GreenTree Inn (Beijing Huilongguan Pingxifu Subway Station Express Hotel)",
            ...
            "Beijing Yayue Hotel (Tongren Hospital, Beijing Chonwenmen)",
            ...
            "Homeinn Selected (Beijing Mudanyuan Metro Station)",
            "Oriental Garden Hotel",
            "Home Inn (Beijing Chaoyang Road Ciyunsi Bridge Yuanyang International Centre)",
            "Jingyi Hotel",
            ...
            "China Palace Hotel",
            "City Comfort Inn (Beijing Qianmen)",
            "Beijing Palace International Hotel",
            "GreenTree Inn (Beijing Happy Valley)",
            "Jinjiang Inn (Beijing Guangqumen)",
            "King Wing Hot Spring Hotel",
            "Home Inn (Beijing Suzhou Bridge National Academy of Governance East Gate)",
            "Home Inn (Beijing Shunyi Center Metro Station)",
            ...
            "Beijing Yantai Mountain Business Club",
            "Super 8 Hotel (Beijing Headquarter Base)",
            ...
            "Shanshui Trends Hotel (Beijing Liyuan Metro Station)",
            "Nishi Haitai Hotel (Beijing Sijiqing)",
            "Beijing Railway Shengda Mansion",
            ...
            "7 Days Inn （Beijing Taoranting Subway） ",
            "Boutique Hotel",
            "Grand Hotel Yuanshan-Beijing",
            ...
            "Yitel (Caiman Street, Beijing Communication University)",
            "Hubei Hotel",
            ...
            "Yitel (Beijing Asian Games Village Birds Nest)",
            "Jinjiang Inn (Beijing Xisi)",
            ...
            "Home Inn (West Door of Communication University of China)",
            "Beijing Ausotel Dayu Hotel",
            "Ping An Fu Hotel ",
            ...
            "7 Days Inn (China Agricultural University South Road)",
            ...
            "Baina Yantaishan Hotel (Beijing Wanfeng Road)",
            "Beijing Penta Hotel",
            "Hotels in Nanjing Grand Hotel",
            "Jinglin Hotel",
            "Tai Mu Shan International Business Hotel",
            "Crystal Orange Hotel (Beijing Qianmen)",
            "Park Plaza Beijing Science Park Hotel",
            ...
            "Starway Hotel ",
            "Ligen Hotel Beijing",
            "Q+ Beijing Shimao Intl Apartment",
            "Shindom Inn (Beijing Xianmen)",
            ...
            "Beijing River View Hotel",
            "Dongfang Hotel Beijing",
            "99 Inn (Beijing Wangfujing Dengshikou Subway Station)",
            "Beijing Ruian Hotel",
            "Hanting Hotel (Beijing South Railway Station South) ",
            "Beijing GuiZhou Hotel",
            "Prime Hotel Beijing",
            ...
            "Jinjiang Inn (Beijing Zhongguancun)",
            "Starway Hotel",
            ...
            "Yuhuagong Hotel",
            "Zhejiang Hotel",
            "Yong Xing Garden Hotel Beijing",
            ...
            "Weese Theme Hotel (East of Liuliqiao, Beijing West Railway Station)",
            "Beijing Media Center",
            "7 Days Inn (Beijing Xueyuan Road II)",
            ...
            "Lavande Hotel (Beijing Asian Sports Village, Bird's Nest)",
            "GreenTree Inn (Beijing Capital International Airport Xinguozhan Metro Station)",
            ...
            "Xiao Yuan Alley Hotel (Beijing Wangfujing Siheyuan)",
            "West International Trade Grand Hotel",
            ...
            "Sheraton Grand Beijing Dongcheng Hotel",
            "Shangkeyou Express Hotel (Beijing Liangxiang Xilu branch)",
            "Hejia Inn (Beijing Children's Hospital)",
            "East Hotel Beijing",
            ...
            "Jiatai International Business Hotel",
            "Beijing Boutique Hotel ",
            ...
            "Home Inn (Beijing Beitaipingzhuang)",
            ...
            "Chenji Hotel (Beijing Yizhuang Branch) (Formerly Rongchen Business Hotel)",
            "Beijing Hotel NUO",
            ...
            "CitiGO Hotel Nanluoguxiang Beijing",
            ...
            "Eaself Hotel Beijing",
            "Orange Hotel Select (Beijing Yizhuang Tongji South Road)",
            "IU Hotel (Beijing DBC Town)",
            ...
            "Huiteng Business Hotel (Beijing Workers' Stadium)",
            ...
            "Home Inn （Hotel Beijing Suzhouqiao）",
            "Grand Hyatt Hotel Beijing",
            "Four Seasons Apple Hotel (Beijing Wanda Plaza) (Formerly Apple Hotel)",
            "Home Inn Plus (Beijing Chaoyangmen Metro Station)",
            "Jingguang Center Apartment Hotel",
            "Film Hotel (Beijing Xizhimen Zhanlanguan Road)",
            "Guorun Business Hotel",
            "Home inn (Beijing Tongzhou Xinhua Street Yunhe Culture Square)",
            "Beijing Hilton Hotel",
            "Ruicheng Hotel",
            "Shenggang International Hotel",
            "Beijing Zhong Yi Peng Ao Hotel",
            "Three Kingdoms Binshe Cultural Boutique Hotel (Beijing Capital Airport New International Expo Center)",
            "Grace Inn (Beijing Daxing Wangfujing Guanyin Temple) ",
            "Beijing HWA Hotel",
            "Grand Metro Park Hotel Beijing",
            "RHX Hotel Beijing",
            ...
            "Beijing Friendship Hotel Grand Building",
            "Zhong Ji Subaru Hotel",
            "Beijing Jing Yan Hotel",
            ...
            "Hill Lily Courtyard（Tian'anmen）",
            "Ibis Hotel (Beijing Dacheng Road) ",
            ...
            "7 Days Inn (Beijing Yizhuang Rongjing East Street Subway Station Kechuang 3rd Street)",
            ...
            "Xilong Hotel (Beijing Xizhao Temple)",
            ...
            "Hanting Hotel (Beijing Capital Indoor Stadium)",
            "Crowne Plaza Beijing Chaoyang U-Town",
            "Dafang Hotel",
            "Beijing Xinxiang Yayuan Apartment (Wangfujing)",
            "Hanting Hotel (Beijing West Station North Square)",
            "Yitel Beijing Qianmen",
            "99 preferred hotel (Beijing Liangxiang Nanguan Railway Station)",
            "Springs Valley Hotel (Beijing Tiantan)",
            ...
            "Home Inn (Beijing Shichahai Drum Tower Jiaodaokou)",
            ...
            "Qiuguo Hotel (Beijing BIEC & Airport)",
            ...
            "Courtyard 7 Hotel",
            "Upscale hotel",
            "GreenTree Alliance Hotel (Beijing West Railway Station North Square Ruihai Building)",
            ...
            "The Lakeview Hotel",
            "Beijing Hepingli Hotel",
            "Somerset Apartment Hotel Beijing",
            "Pod Inn (Beijing Water Cube) ",
            "Guohong Hotel Beijing",
            "Orange Hotel Select (Beijing Headquarter)",
            "Beijing Xiyuan Hotel",
            "GreenTree Inn (Beijing Capital Airport Terminal)",
            "Lake View Hotel Beijing",
            "ZMAX Hotels (Beijing Yizhuang)",
            "Hanting Hotel (Beijing South Gate of Temple of Heaven)",
            "Beijing Tonglian Taihe Hotel",
            "Beijing Bishuiyuntian Hotel (Beijing Happy Valley)",
            "Beijing Jiangsu Plaza Hotel",
            "National Library Hotel",
            "Hanting Hotel (Beijing Huixin East Bridge)",
            "Southern Airlines Hotel Beijing",
            "Changyue Fashion Hotel (Formerly Lehuo Hotel)",
            ...
            "Shiji Huangshan Hotel",
            "Thankyou Quick Hotel (Beijing panjiayuan)",
            ...
            "Home Inn (Beijing Capital International Airport)",
            ...
            "Home Inn (Beijing Asian Sports Village Xiaoying Guanzhuang Subway Station) ",
            ...
            "7 Days Inn (Beijing Jimenqiao)",
            "Renaissance Beijing Capital Hotel",
            "Citadines Apartment Beijing",
            "7 Days Inn (Beijing Qianmen)",
            "Shen Zhou International Hotel Beijing",
            "XY Apartment Hotel (Beijing Jinmaofu)",
            "Beijing Dafang Hotel",
        ...
        "Hotel Facilities": [
            ...
            "Foreign guest",
            "each",
            "Business center and public areas",
